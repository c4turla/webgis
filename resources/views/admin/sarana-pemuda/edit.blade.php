                            ...
                            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                                <div class="xl:col-span-6">
                                    ...
                                    <input type="text" id="nama_tempat" name="nama_tempat"
                                        ...
                                        placeholder="Nama Tempat" required="" value="{{ $spemuda->nama_tempat }}">
                                </div>
                                <!--end col-->
                                <div class="xl:col-span-6">
                                    <label for="kategori"
                                ...
                                <div class="lg:col-span-2 xl:col-span-12">
                                    <div>
                                        ...
                                        <textarea name="deskripsi"
                                            ...
                                            rows="5">{{ $spemuda->deskripsi }}</textarea>
                                    </div>
                                </div>
                                <div class="xl:col-span-4">
                                    ...
                                    <input type="number" id="harga_tiket" name="harga_tiket"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Harga Tiket" value="{{ $spemuda->harga_tiket }}">
                                </div>
                                <!--end col-->
                                <div class="xl:col-span-4">
                                ...
                                <div class="xl:col-span-4">
                                    ...
                                    <input type="text" id="fasilitas" name="fasilitas"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Fasilitas" value="{{ $spemuda->fasilitas }}">
                                </div>
                                <!--end col-->
                                <div class="xl:col-span-4">
                                    ...
                                    <input type="text" id="kontak" name="kontak"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Kontak" value="{{ $spemuda->kontak }}">
                                </div>
                                <div class="xl:col-span-4">
                                    ...
                                    <select
                                        ...
                                        <option value="aktif" {{  $spemuda->status == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="nonaktif" {{  $spemuda->status == 'nonaktif' ? 'selected' : '' }}>Non Aktif</option>
                                    </select>
                                </div>
                                ...
                                <div class="xl:col-span-6">
                                    ...
                                    <input type="text" id="latitude" name="latitude"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Latitude" value="{{ $spemuda->latitude }}">
                                </div>
                                <!--end col-->
                                <div class="xl:col-span-6">
                                    <label for="longitude"
                                    ...
                                    <input type="text" id="longitude" name="longitude"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        placeholder="Longitude" value="{{ $spemuda->longitude }}">
                                </div>
                                <div class="lg:col-span-2 xl:col-span-12">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
            var lat = @json($spemuda->latitude ?? -3.8087);
            var lng = @json($spemuda->longitude ?? 122.3060);
            var zoomLevel = 10;
