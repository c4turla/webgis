...
@section('content')
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            <a href="#!">
                <img src="{{ URL::to('assets/images/logolight.png') }}" alt="" class="hidden h-15 mx-auto dark:block">
                <img src="{{ URL::to('assets/images/logodark.png') }}" alt="" class="block h-15 mx-auto dark:hidden">
            </a>
            <div class="mt-8 text-center">
                <div class="mb-4 text-center">
                    <i data-lucide="log-out" class="mx-auto text-purple-500 size-6 fill-purple-100"></i>
                </div>
                <h4 class="mb-2 text-custom-500 dark:text-custom-500">Kamu Berhasil Keluar Dari Aplikasi</h4>
                <p class="mb-8 text-slate-500 dark:text-zink-200">Terima Kasih</p>
            </div>
