<nav class="flex flex-row py-4 px-6 justify-between items-center bg-primary-900">
    ...
    <div class="sm:hidden flex items-center">
        ...
        <label for="menu-toggle" class="cursor-pointer flex items-center">
            <svg id="hamburger-icon" class="w-6 h-6 block" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
            </svg>
            <svg id="close-icon" class="w-6 h-6 hidden" fill="none" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div class="sm:hidden flex flex-col w-full hidden gap-2 p-4" id="mobile-nav">
    <div class="flex flex-row items-center cursor-pointer group w-full text-white gap-3">
        <i data-lucide="home" class="h-10 mb-1" style="color: white;"></i>
        <a class="tracking-widest font-semibold">BERANDA</a>
    </div>
    <div class="flex flex-row items-center cursor-pointer group w-full text-white gap-3">
        <i data-lucide="headphones" class="h-10 mb-1" style="color: white;"></i>
        <a class="tracking-widest font-semibold">PENGADUAN</a>
    </div>
    <div class="flex flex-row items-center cursor-pointer group w-full text-white gap-3">
        <i data-lucide="book-open-text" class="h-10 mb-1" style="color: white;"></i>
        <p class="tracking-widest font-semibold">PANDUAN</p>
    </div>
    <div class="flex flex-row  items-center cursor-pointer group w-full text-white gap-3">
        <i data-lucide="message-circle" class="h-10 mb-1" style="color: white;"></i>
        <p class="tracking-widest font-semibold">FAQ</p>
    </div>
</div>
